package com.app.apicalling.Database;
...
public class TinyDB {
    ...
    public ArrayList<Artworks> getArtworks(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Artworks> playerList =  new ArrayList<Artworks>();

        for(String jObjString : objStrings){
            Artworks player  = gson.fromJson(jObjString,Artworks.class);
